...
# 上传文件
def upload_file(client_id, client_secret, parent, folder_name, file_path,flag):
    token = ''
    try:
        res_data = open_request('/api/v1/access_token', {'clientID': client_id, 'clientSecret': client_secret}, token)
        token = res_data['accessToken']
...
client_id = 'a7a437c9b93e4667b7fdf46ef7e912cb'  # 用户申请到的clientID
client_secret = '6c09be6b4ef44406808eba1abd0d6222'  # 用户申请到的clientSecret
#parent_file_id = 4119655  # 上传到的父级目录id，根目录为0
#local_file_path = 'C:\\Users\\44615\\PycharmProjects\\Demo_Pan\\data\\depots\\1000360\\1000360.txt'  # 用户本地的文件绝对路径


def upload_file_pan(app_id,file_path,parent_file_id,flag):
    upload_file(client_id, client_secret, parent_file_id, app_id, file_path,flag)
